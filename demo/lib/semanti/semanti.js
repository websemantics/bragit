/**
 * Semanti : Shows your Github repositories stats in style using Semantic-ui labeled buttons
 *
...
;(function (root, factory) {
  ...
  */
  ...
  me.init = function () {
    ...
    /* get all classes with the set selector */
    ...
    /* request information of all repositories mentioned, and made changes to html code, fun fun! */
    for(var i in repos){
